...
import questions from '../../../data/reactQ/companyInfoQuestions'
...
const CategoryCompanyInfo = ({ onChange, score, categorySelected, setCategorySelected }) => {
...
export default CategoryCompanyInfo;