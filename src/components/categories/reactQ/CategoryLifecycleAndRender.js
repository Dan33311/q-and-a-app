...
import questions from '../../../data/reactQ/lifecycleAndRenderQuestions'
...
const CategoryLifecycleAndRender = ({ onChange, score, categorySelected, setCategorySelected }) => {
...
export default CategoryLifecycleAndRender;