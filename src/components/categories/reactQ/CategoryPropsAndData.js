...
import questions from '../../../data/reactQ/propsAndDataQuestions'
...
const CategoryPropsAndData = ({ onChange, score, categorySelected, setCategorySelected }) => {
...
export default CategoryPropsAndData;